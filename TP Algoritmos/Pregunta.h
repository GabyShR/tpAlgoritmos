...
BancoDePreguntas::BancoDePreguntas()
{
	...
	ArrBancoDePreguntas.push_back("Hay 3 cajas de igual tamaño. Dentrode cada una de las tres cajas  hay otras dos mas pequeñas, y en cada  una de ellas hay otras cuatro      todavia mas pequeñas. Cuantas cajashay en total?");
